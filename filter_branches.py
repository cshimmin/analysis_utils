...
if __name__ == "__main__":
	parser = argparse.ArgumentParser(description="Keep only branches that match expressions in a file.")
	...
	for in_file in input_files:
		...
		if args.out == "":
			...
			out_file_name = os.path.join(args.out, os.path.basename("%s.%s"%(in_file,args.ext)))
